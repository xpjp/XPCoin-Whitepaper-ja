...
暗号通貨を革命的にする1つの特徴は、金融システムに対する信頼性を取り除いていることです。
...
"Proof of Work" (PoW)通貨は、ネットワークを保全するために複雑な計算の実行をコンピュータに頼っています。
...
PoW通貨は使用される処理能力の大部分をコントロールするアクター(訳注: 人や組織など)によってネットワークの安全性が左右されるので、信頼性が非常に低くなっていきます。
